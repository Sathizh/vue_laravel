        ...
        <h2 class="text-center p-2 text-white bg-primary mt-5">
            ...
            <div class="card-body">
                <div class="col-md-6 offset-md-3">
                    <form method="post" id="validateForm" @submit.prevent="updateContact" novalidate enctype="multipart/form-data">
                        ...
                        <div class="custom-file">
                            <input type="file" name="image" class="form-control" id="validateCustimFile" v-on:change="onImageChange">
                        </div>
...
export default {
    ...
    methods:{
        loadData(){
            let url=this.url+  `/api/search_contact/${this.$route.params.id}`;
